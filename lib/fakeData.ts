...
export const fakeData: FakeData = {
  ...
  news: [
    ...
    },
    {
      id: 1,
      title:
        '大学の授業再開に伴い、国際法研でもAセメスターの活動が本格的に始動しました！',
      content:
        '<p>Aセメスターでは模擬裁判大会への参加と、4つの勉強会を実施します！</p><p>&nbsp;</p><p>Philip C. Jessup International Moot Court: 60年以上続く世界最大の大会です。当研究会は国内予選2連覇と世界大会で勝ち上がることを目標にしています。今年は全学年から数多くの参加者が集まり、チーム一丸となって準備しています！</p><p>&nbsp;</p><p>国際法勉強会：Ｓセメスターに続き、国際法の基礎を学ぶ国際法勉強会を毎週月曜日5限後に駒場キャンパスで実施します！講義する上級生には模擬裁判経験が豊富なメンバーも多く、充実した講義を用意しています。また、グループワークも用意しているので、メンバー間の交流の機会にもなっています。</p><p>&nbsp;</p><p>宇宙法ゼミ：宇宙開発が進むにつれて整備が急がれている宇宙法について学ぶゼミです。講義をするのは昨年度の宇宙法模擬裁判大会国内最優秀弁論者などの上級生です。ゼミに参加した人の中で希望者は3月に行われる宇宙法模擬裁判大会へ出場します。</p><p>&nbsp;</p><p>国際投資法ゼミ：グローバライゼーションに伴い国際投資協定と投資仲裁が重要になってきています。このゼミでは、教科書を中心に学び、最終的には来年度のFDI Moot（国際投資仲裁の模擬裁判）に出場することを目指しています。</p><p>&nbsp;</p><p>国際法政治古典ゼミ：現代の国際法・国際政治に繋がる政治哲学について学ぶゼミです。今セメスターでは、エマニュエル・カントの政治哲学の基礎的な部分について学び、最終的に『永遠平和のために』を輪読します。</p><p>&nbsp;</p><p>以上に加え、対面イベントを始めとした単発の企画も適宜実施していきます！</p>',
      created_at: moment('2022-10-12').toString(),
      updated_at: null,
      tag: '',
      status: 'public',
    },
