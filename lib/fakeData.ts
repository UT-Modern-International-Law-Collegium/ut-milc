  ...
  news: [
    {
      ...
      content:
        '<p>ホームページをリニューアルしてます。</p>\r\n<p>HP制作過程については<a href="https://yakan.blog/utmilc-hp" rel="noopener" target="_blank">こちらの記事</a>にいろいろ書いてます。ぜひご一読いただけると嬉しいです！<br/><br/></p>\r\n\r\n<p>「ホームページのリニューアル」と言ってもまだ初版リリースをしただけで、絶賛制作中です。いろいろ雑な部分が多いんですよね。。今後しっかり詰めていきます。テキトーなところがはびこってるのが現状ですが、どうか多めに見ていただけると。。</p>',
